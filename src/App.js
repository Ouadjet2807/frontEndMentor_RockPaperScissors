    ...
    <div className="App">
      ...
      <div className={`game ${userChoice !== undefined ? "started" : ""}`}>
        ...
        <div className="pentagon" >
          ...
          <svg xmlns="http://www.w3.org/2000/svg" className="bg" viewBox="0 0 330 330" preserveAspectRatio="xMidYMid"><path style={{zIndex: `${gameState === "complete" ? '0' : '1'}`}} fill="none" stroke="#000" stroke-width={width > 375 ? "15" : "25"} width="100%" height="100%" d="M164.5 9.27L9.26 122.06l59.296 182.495h191.888L319.74 122.06 164.5 9.271z" opacity=".2"/></svg>
        </div>
